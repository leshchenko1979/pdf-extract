...
REMOTE_DOCKER_DIR="${REMOTE_DOCKER_DIR:-/root/services/pdf-extract}"
...
grep -vE '^(SSH_HOST|SSH_USER|SSH_KEY|SSH_PORT|GHCR_PULL_USER|GHCR_PULL_TOKEN|REMOTE_USER|REMOTE_HOST_IP)=' .env > "$RUNTIME_ENV"
